...
Shader "SineVFX/LivingParticles/LivingParticleAlphaBlendedArray"
{
	Properties
	{
...
/*ASEBEGIN
Version=16807
7;29;1906;1004;4343.838;2657.318;1.6;True;False
Node;AmplifyShaderEditor.TexCoordVertexDataNode;102;-3263.097,-2073.739;Float;False;0;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexCoordVertexDataNode;103;-3256.097,-1824.74;Float;False;1;4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;17;-2928.958,-1908.748;Float;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GlobalArrayNode;112;-3020.516,-1638.861;Float;False;_Affectors;0;20;2;False;False;0;1;False;Object;-1;4;0;INT;0;False;2;INT;0;False;1;INT;0;False;3;INT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SamplerNode;82;-437.946,-1036.915;Float;True;Property;_Ramp;Ramp;8;0;Create;True;0;0;False;0;None;96f1785558043bf48bacf57b6511b602;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;122;-852.9348,-411.0603;Float;False;0;101;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;101;-534.2034,-388.7517;Float;True;Property;_FinalTexture;Final Texture;2;0;Create;True;0;0;False;0;None;7274495111a104d428fd6376d142ecfe;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CustomExpressionNode;111;-2500.186,-2084.218;Float;False;float4 normalizeResultMY@$$for (int w = 0@ w < _AffectorCount@ w++) {$if(w == 0){$normalizeResultMY = normalize( ParticleCenterCE - _Affectors[w] ) * ( clamp( (0.0 + (( 1.0 - distance( ParticleCenterCE , _Affectors[w] ) + ( _Distance - 1.0 ) ) - 0.0) * (1.0 - 0.0) / (_Distance - 0.0)) , 0.0 , 1.0 ) + 0.00001 )@$}else{$normalizeResultMY = normalizeResultMY + normalize( ParticleCenterCE - _Affectors[w] ) * ( clamp( (0.0 + (( 1.0 - distance( ParticleCenterCE , _Affectors[w] ) + ( _Distance - 1.0 ) ) - 0.0) * (1.0 - 0.0) / (_Distance - 0.0)) , 0.0 , 1.0 ) + 0.00001 )@$}$}$return normalize(normalizeResultMY)@;4;False;2;True;ParticleCenterCE;FLOAT4;0,0,0,0;In;;Float;False;True;AffectorsCE;FLOAT4;0,0,0,0;In;;Float;False;CE2;True;False;0;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;126;-2459.031,-2297.316;Float;False;float4 normalizeResultMY@$$for (int w = 0@ w < _AffectorCount@ w++) {$if(w == 0){$normalizeResultMY = normalize( ParticleCenterCE - _Affectors[w] ) * ( clamp( (0.0 + (( 1.0 - distance( ParticleCenterCE , _Affectors[w] ) + ( _Distance - 1.0 ) ) - 0.0) * (1.0 - 0.0) / (_Distance - 0.0)) , 0.0 , 1.0 ) + 0.00001 )@$}else{$normalizeResultMY = normalizeResultMY + normalize( ParticleCenterCE - _Affectors[w] ) * ( clamp( (0.0 + (( 1.0 - distance( ParticleCenterCE , _Affectors[w] ) + ( _Distance - 1.0 ) ) - 0.0) * (1.0 - 0.0) / (_Distance - 0.0)) , 0.0 , 1.0 ) + 0.00001 )@$}$}$return normalize(normalizeResultMY)@;4;False;2;True;ParticleCenterCE;FLOAT4;0,0,0,0;In;;Float;False;True;AffectorsCE;FLOAT4;0,0,0,0;In;;Float;False;CE2;True;False;0;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;42;1547.305,4.452129;Float;False;4;4;0;FLOAT;0;False;1;FLOAT4;0,0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3;1551.454,-731.9276;Float;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;125;2555.304,-451.5145;Float;False;True;2;Float;ASEMaterialInspector;0;0;Unlit;SineVFX/LivingParticles/LivingParticleAlphaBlendedArray;False;False;False;False;True;True;True;True;True;False;True;True;False;False;True;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0.5;True;False;0;False;Transparent;;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;125;2;3;0
WireConnection;125;9;74;0
WireConnection;125;11;42;0
ASEEND*/
//CHKSM=3B8003020FF6B3C7B5AE2DE1511AB8301A3443FC